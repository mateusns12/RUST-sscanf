...
mod scan{
    ...
    pub macro scan_to_new ($buffer:expr,$sep:expr,[$($y:ty),+],$($x:expr),+){
...
fn main() {
    ...
    let sep = [':',';',','];
    scan::scan_to_new!(buffer,sep,[u8,i32,i16,f32],a,b,c,d);
    println!("{} {} {} {}",a,b,c,d);

    let a :u8;   let b :i32;   let c :i16;   let d :f32;   let e :String;
    let buffer = "02:98;abc,39.6";
    let sep = [':',';',',',' '];
    scan::scan_to_new!(buffer,sep,[u8,i32,String,f32],a,b,e,d);
    println!("{} {} {} {}",a,b,e,d);
    ...
    scan::scan_to_new!(buffer,sep,[u8,u8,u8,i32,String,u8,u8,u8,i32],a,b,c,d,e,f,g,h,i);
